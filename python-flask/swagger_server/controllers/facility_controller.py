...
def search_facility(size=None, page=None, sort=None, name=None, company=None):  # noqa: E501
...
def search_wips(size=None, page=None, sort=None, name=None, facility=None):  # noqa: E501
