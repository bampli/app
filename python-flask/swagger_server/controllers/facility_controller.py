...
def search_facility(size=None, page=None, sort=None, name=None, companyid=None):  # noqa: E501
    ...
    :type name: str
    :param companyid: Allows to filter the collections of result by companyid
    :type companyid: str
