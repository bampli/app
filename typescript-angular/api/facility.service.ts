...
export class FacilityService {
    ...
    public addFacility(body: Facility, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Facility>('post',`${this.basePath}/facility_id/`,
            {
                body: body,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public searchFacility(size?: number, page?: number, sort?: string, name?: string, companyId?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Facility>>;
    public searchFacility(size?: number, page?: number, sort?: string, name?: string, companyId?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Facility>>>;
    public searchFacility(size?: number, page?: number, sort?: string, name?: string, companyId?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Facility>>>;
    public searchFacility(size?: number, page?: number, sort?: string, name?: string, companyId?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<Facility>>('get',`${this.basePath}/facility_id/`,
            {
     ...
     * @param sort Order in which to retrieve the results. Multiple sort criteria can be passed. Example: sort&#x3D;name ASC,city DESC
     * @param name Allows to filter the collections of result by name
     * @param facilityId Allows to filter the collections of result by facility_id
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public searchWips(size?: number, page?: number, sort?: string, name?: string, facilityId?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Wip>>;
    public searchWips(size?: number, page?: number, sort?: string, name?: string, facilityId?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Wip>>>;
    public searchWips(size?: number, page?: number, sort?: string, name?: string, facilityId?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Wip>>>;
    public searchWips(size?: number, page?: number, sort?: string, name?: string, facilityId?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        if (facilityId !== undefined && facilityId !== null) {
            queryParameters = queryParameters.set('facility_id', <any>facilityId);
        }
