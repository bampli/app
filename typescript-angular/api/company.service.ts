...
export class CompanyService {
    ...
    public addCompany(body: Company, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Company>('post',`${this.basePath}/company_id/`,
            {
                body: body,
    ...
    public searchCompanies(size?: number, page?: number, sort?: string, name?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<Array<Company>>('get',`${this.basePath}/company_id/`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public searchProducts(size?: number, page?: number, sort?: string, name?: string, companyId?: string, observe?: 'body', reportProgress?: boolean): Observable<Array<Product>>;
    public searchProducts(size?: number, page?: number, sort?: string, name?: string, companyId?: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Product>>>;
    public searchProducts(size?: number, page?: number, sort?: string, name?: string, companyId?: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Product>>>;
    public searchProducts(size?: number, page?: number, sort?: string, name?: string, companyId?: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
