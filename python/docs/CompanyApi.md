...
# **search_products**
> list[Product] search_products(size=size, page=page, sort=sort, name=name, company=company)
...
try:
    # Load the list of Products
    api_response = api_instance.search_products(size=size, page=page, sort=sort, name=name, company=company)
    pprint(api_response)
except ApiException as e:
