...
------------- | ------------- | -------------
[**add_company**](CompanyApi.md#add_company) | **POST** /companyid/ | Create a new Company
...
[**search_companies**](CompanyApi.md#search_companies) | **GET** /companyid/ | Load the list of Companies
...
# **search_products**
> list[Product] search_products(size=size, page=page, sort=sort, name=name, companyid=companyid)
...
try:
    # Load the list of Products
    api_response = api_instance.search_products(size=size, page=page, sort=sort, name=name, companyid=companyid)
    pprint(api_response)
except ApiException as e:
