...
# **search_cyclos**
> list[Cyclo] search_cyclos(size=size, page=page, sort=sort, name=name, company=company)
...
company = '\"0e8cedd0-ad98-11e6-bf2e-47644ada7c0f\"' # str | Allows to filter the collections of result by company (optional)

try:
    # Load the list of Cyclos
    api_response = api_instance.search_cyclos(size=size, page=page, sort=sort, name=name, company=company)
    pprint(api_response)
except ApiException as e:
 ...
 **company** | **str**| Allows to filter the collections of result by company | [optional] 
...
# **search_stages**
> list[Stage] search_stages(size=size, page=page, sort=sort, name=name, cyclo=cyclo)
...
cyclo = '\"0e8cedd0-ad98-11e6-bf2e-47644ada7c0f\"' # str | Allows to filter the collections of result by cyclo (optional)

try:
    # Load the list of Stages
    api_response = api_instance.search_stages(size=size, page=page, sort=sort, name=name, cyclo=cyclo)
    pprint(api_response)
except ApiException as e:
 ...
 **name** | **str**| Allows to filter the collections of result by name | [optional] 
 **cyclo** | **str**| Allows to filter the collections of result by cyclo | [optional] 
...
# **search_tasks**
> list[Task] search_tasks(size=size, page=page, sort=sort, name=name, stage=stage)
...
name = '\"George Street Brewery\"' # str | Allows to filter the collections of result by name (optional)
stage = '\"0e8cedd0-ad98-11e6-bf2e-47644ada7c0f\"' # str | Allows to filter the collections of result by stage (optional)

try:
    # Load the list of Tasks
    api_response = api_instance.search_tasks(size=size, page=page, sort=sort, name=name, stage=stage)
    pprint(api_response)
except ApiException as e:
 ...
 **name** | **str**| Allows to filter the collections of result by name | [optional] 
 **stage** | **str**| Allows to filter the collections of result by stage | [optional] 
