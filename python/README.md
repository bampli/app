...
------------ | ------------- | ------------- | -------------
*CompanyApi* | [**add_company**](docs/CompanyApi.md#add_company) | **POST** /companyid/ | Create a new Company
...
*CompanyApi* | [**search_companies**](docs/CompanyApi.md#search_companies) | **GET** /companyid/ | Load the list of Companies
