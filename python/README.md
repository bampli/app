...
------------ | ------------- | ------------- | -------------
*CompanyApi* | [**add_company**](docs/CompanyApi.md#add_company) | **POST** /company_id/ | Create a new Company
...
*CompanyApi* | [**search_companies**](docs/CompanyApi.md#search_companies) | **GET** /company_id/ | Load the list of Companies
...
*FacilityApi* | [**add_facility**](docs/FacilityApi.md#add_facility) | **POST** /facility_id/ | Create a new Facility
...
*FacilityApi* | [**search_facility**](docs/FacilityApi.md#search_facility) | **GET** /facility_id/ | Load the list of Facilities
