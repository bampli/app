...
class FacilityApi(object):
    ...
    def search_facility(self, **kwargs):  # noqa: E501
        ...
        :param str companyid: Allows to filter the collections of result by companyid
    ...
    def search_facility_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['size', 'page', 'sort', 'name', 'companyid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'companyid' in params:
            query_params.append(('companyid', params['companyid']))  # noqa: E501
