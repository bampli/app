...
class CycloApi(object):
    ...
    def search_cyclos(self, **kwargs):  # noqa: E501
        ...
        :param str company: Allows to filter the collections of result by company
        :return: list[Cyclo]
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def search_cyclos_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['size', 'page', 'sort', 'name', 'company']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def search_stages(self, **kwargs):  # noqa: E501
        ...
        :param str name: Allows to filter the collections of result by name
        :param str cyclo: Allows to filter the collections of result by cyclo
        :return: list[Stage]
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def search_stages_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['size', 'page', 'sort', 'name', 'cyclo']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'name' in params:
            query_params.append(('name', params['name']))  # noqa: E501
        if 'cyclo' in params:
            query_params.append(('cyclo', params['cyclo']))  # noqa: E501
    ...
    def search_tasks(self, **kwargs):  # noqa: E501
        ...
        :param str name: Allows to filter the collections of result by name
        :param str stage: Allows to filter the collections of result by stage
        :return: list[Task]
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def search_tasks_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['size', 'page', 'sort', 'name', 'stage']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
